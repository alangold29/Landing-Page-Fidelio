...
function ClosingSection() { return <section id="demo" className="relative isolate overflow-hidden bg-[#131612] px-8 py-32 text-white md:px-12 md:py-40"><p aria-hidden="true" className="pointer-events-none absolute bottom-[-0.38em] left-1/2 z-0 w-max -translate-x-1/2 -rotate-[7deg] select-none font-display text-[clamp(8rem,27vw,27rem)] font-medium leading-none tracking-[-.12em] text-white/[0.055]">Taply.</p><div className="relative z-10 grid grid-cols-12 gap-12"><div className="col-span-12 md:col-span-8"><p className="mb-12 text-[11px] uppercase tracking-[0.2em] text-white/45">Empieza a aumentar la frecuencia de visita</p><AnimatedHeading className="font-display text-5xl font-medium leading-[1.02] tracking-[-.035em] md:text-7xl">Convierte más visitas<br/><span className="text-white/40">en clientes habituales.</span></AnimatedHeading></div><div className="col-span-12 self-end md:col-span-3 md:col-start-10"><AnimatedText className="text-base leading-relaxed text-white/50">Reserva una demo y descubre qué programa, campaña y métrica tienen más sentido para tu negocio.</AnimatedText><a href="https://cal.com/alan-goldstein-z1hmxl/demo-fidelio" className="mt-8 inline-flex items-center gap-3 rounded-full bg-white py-2 pl-6 pr-2 text-sm font-medium text-foreground transition hover:bg-white/90">Reserva una demo<span className="flex h-9 w-9 items-center justify-center rounded-full bg-foreground text-white"><ArrowUpRight className="h-4 w-4"/></span></a></div></div></section> }
