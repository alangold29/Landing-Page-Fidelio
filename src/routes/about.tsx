...
const principles = [
  ...
  ['La tecnología debe desaparecer', 'Si exige otra app, otra contraseña o una operación más compleja en caja, termina siendo una barrera. Por eso Taply vive donde el cliente ya guarda lo importante.'],
  ['La relación es del negocio', 'Taply no reemplaza la cercanía de un negocio local. La hace más fácil de sostener entre una visita y la siguiente.'],
]
    ...
    <section className="px-5 pb-20 sm:px-8 md:px-12 md:pb-32">
      <div className="grid grid-cols-12 gap-10 md:gap-12">
        <div className="col-span-12">
          <p className="mb-8 text-[11px] uppercase tracking-[0.2em] text-muted-foreground">Sobre Taply</p>
      ...
      <div className="mt-16 grid grid-cols-1 gap-4 md:mt-24 md:grid-cols-12 md:items-end md:gap-8">
        <div className="overflow-hidden rounded-[28px] bg-[#d8e4f1] md:col-span-7"><img src="/fidelio-card-strip.png" alt="Tarjeta Taply de referencia" className="h-[260px] w-full object-cover sm:h-[340px] md:h-[420px]"/></div>
